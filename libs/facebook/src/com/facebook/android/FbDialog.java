...
public class FbDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSpinner.setOnCancelListener(new OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                ...
                Toast.makeText(mSpinner.getContext(), "Progress Dialog cancelled", Toast.LENGTH_SHORT).show();
            }
    ...
    protected void createCrossImage() {
    ...
    protected class FbWebViewClient extends WebViewClient {
            ...
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    if(mWebView.getProgress() < 100) {
                        FbWebViewClient.this.onReceivedError(mWebView, WebViewClient.ERROR_TIMEOUT, 
                                "The connection to the server timed out.", page);
                    }
