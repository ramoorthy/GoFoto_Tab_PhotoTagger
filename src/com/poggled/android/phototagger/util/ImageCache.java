...
/* @author: Jason Harris modified to add functionality to remove cached bitmaps by key name with removeBitmapFromCache */
        ...
        if (mMemoryCache != null) {
            ...
            if (memBitmap != null) {
                if (BuildConfig.DEBUG) {
                    Log.d(TAG, "Memory cache hit - " + data + " size: " + Utils.getBitmapSize(memBitmap));
                }
                return memBitmap;
            }
        }
