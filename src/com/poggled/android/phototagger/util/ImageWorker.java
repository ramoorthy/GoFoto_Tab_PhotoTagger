...
public abstract class ImageWorker {
    ...
    private void setImageBitmap(ImageView imageView, Bitmap bitmap) {
        if (mFadeInBitmap) {
            ...
            // Set background to loading bitmap (removed at this time since it was causing duplicate images if 
            // a transparent background was set and the ImageView has a different scale type like centerCrop) 
